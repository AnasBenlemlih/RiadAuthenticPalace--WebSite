<?php
    ...
    //$subject = "You have a message from {$name} : riadfesauthenticpalace";

    $logo = 'http://www.riadfesauthenticpalace.com/assets/img/logo/logo.png'; 
    $link = 'www.riadfesauthenticpalace.com';
